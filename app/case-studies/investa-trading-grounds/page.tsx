          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-4 max-w-3xl">
              ...
              <p className="text-gray-400">
                Investagrams aimed to transform its image from a serious stock
                trading platform to a more engaging and educational experience.
                To achieve this, we developed Trading Grounds, a gamified
                environment where users can learn stock trading by competing in
                a charting game.
              </p>
            </div>
            <div className="flex flex-col gap-4 max-w-3xl">
              ...
              <p className="text-gray-400">
                ...
                by transforming their stock charting mini-game into a more
                compelling learning tool. Our existing game, Trading Grounds,
                allowed users to predict chart directions but it looked and felt
              ...
              <p className="text-gray-400">
                <span className="font-bold text-gray-300">Our Goal:</span> Make
                Trading Grounds feel like a true game—something users would
                enjoy playing and learn from, without changing the core
                mechanics.
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-10">
              ...
              <div className="flex flex-col gap-4 max-w-3xl">
                ...
                <ul className="list-disc list-none flex flex-col gap-4">
                  ...
                  <li className="text-gray-400 flex flex-row gap-2 self-start items-center">
                    ...
                    Collaborating daily with our illustrator and developers for
              ...
              <div className="flex flex-col gap-4 max-w-3xl">
                ...
                <ul className="list-disc list-inside mb-4">
                  ...
                  <li className="text-gray-400">
                    Collected feedback from Trading Grounds users and early
                    testers.
                  </li>
                  <li className="text-gray-400">
                    Defined our user persona: Beginner traders aged 18–30, often
                    students or hobbyists with zero trading experience
                  </li>
                </ul>

                <h3 className="text-xl font-bold">2. Design</h3>
                <p className="text-gray-400">
                  We created a sci-fi themed interface to evoke the feeling of a
                  futuristic training simulator:
                </p>
                <ul className="list-disc list-inside mb-4">
                  <li className="text-gray-400">
                    Added HUD-style panels, glowing buttons, and animated
                    rewards.
                  </li>
                  <li className="text-gray-400">
                    Designed medal icons and banners that visually indicate
                    progress.
                  </li>
                  <li className="text-gray-400">
              ...
              <div className="flex flex-col gap-4 max-w-3xl">
                ...
                <ul className="list-disc list-inside mb-4">
                  ...
                  <li className="text-gray-400">
                    Ensured responsiveness across breakpoints using
                    component-based layouts.
                  </li>
                  <li className="text-gray-400">
                    Integrated animations using Framer Motion for reward popups,
              ...
              <div className="flex flex-col gap-4 max-w-3xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-1 gap-4">
                  ...
                  <div className="flex flex-col flex-grow-1 gap-2 justify-between rounded-lg border border-gray-300 hover:border-blue-300 transition-all duration-300 p-6">
                    Over 1,500 games played per day within the first month
                  </div>
                </div>
                <p>
                  We also hosted our first live tournament at the 2019
                  Investagrams Summit with over 2,000 players joined the
              ...
              />
              <div className="flex flex-col gap-4 max-w-3xl">
                <h2 className="text-2xl font-bold">What I've Learned</h2>
                <p className="text-gray-400">
