        ...
        <div className="max-w-7xl m-auto py-15 flex flex-col gap-18">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col gap-4 order-1 xl:order-1">
              ...
              >
                <div className="rounded-lg border border-gray-300 hover:border-blue-300 transition-all duration-300 p-4 flex flex-row gap-2 justify-between text-gray-500">
                  Coming soon...
                  <svg
